...
# 3. Move to DuckDB extensions directory (DuckDB v1.5.5)
mkdir -p ~/.duckdb/extensions/v1.5.5/<PLATFORM>
mv adbc_driver_snowflake/libadbc_driver_snowflake.so ~/.duckdb/extensions/v1.5.5/<PLATFORM>/
...
mv adbc_driver_snowflake/libadbc_driver_snowflake.so ~/.duckdb/extensions/v1.5.5/linux_amd64/
...
# Place in DuckDB extensions directory (DuckDB v1.5.5)
mkdir C:\Users\%USERNAME%\.duckdb\extensions\v1.5.5\windows_amd64
move libadbc_driver_snowflake.so C:\Users\%USERNAME%\.duckdb\extensions\v1.5.5\windows_amd64\
```
